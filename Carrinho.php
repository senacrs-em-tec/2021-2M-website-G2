      ...
      <div class="col-md-8 cart">
          ...
          <div class="row border-top border-bottom">
              <div class="row main align-items-center">
                  <div class="col-2"><img class="img-fluid" src="Imagens/Cards/Casaco5.png"></div>
                  <div class="col">
          ...
          <div class="row">
              <div class="row main align-items-center">
                  <div class="col-2"><img class="img-fluid" src="Imagens/Cards/Casaco2.png"></div>
                  <div class="col">
                      <div class="row text-muted">Jaqueta</div>
          ...
          <div class="row border-top border-bottom">
              <div class="row main align-items-center">
                  <div class="col-2"><img class="img-fluid" src="Imagens/Cards/Casaco1.png"></div>
                  <div class="col">
                      <div class="row text-muted">Jaqueta</div>
